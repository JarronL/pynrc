...
PACKAGENAME = metadata.get('package_name', 'pynrc')
DESCRIPTION = metadata.get('description', 'pynrc')
AUTHOR = metadata.get('author', 'Jarron Leisenring')
AUTHOR_EMAIL = metadata.get('jarronl@email.arizona.edu', '')
LICENSE = metadata.get('license', 'MIT')
URL = metadata.get('url', 'https://github.com/JarronL/pynrc')
