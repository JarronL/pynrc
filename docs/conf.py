...
# -*- coding: utf-8 -*-
#
# pynrc documentation build configuration file, created by
...
project = u'pynrc'
copyright = u'2024, Jarron Leisenring'
...
version = pynrc.__version__
# The full version, including alpha/beta/rc tags.
release = pynrc.__version__
...
latex_documents = [
    (master_doc, 'pynrc.tex',
     u'pyNRC Documentation',
     u'Jarron Leisenring', 'manual'),
]
